...
do
	...
	#./ycsb-0.5.0/bin/ycsb load mongodb-async -s -P LisWorkloadA -p mongodb.url=mongodb://192.168.4.88:27017/ycsb?w=0 -threads $threads > ./logs/$threads/$threads.ycsb.load.log
	./ycsb-0.5.0/bin/ycsb  run  mongodb-async -s -P LisWorkloadA -p mongodb.url=mongodb://${server}:27017/ycsb?w=0 -threads $threads > ./$threads.ycsb.run.log
